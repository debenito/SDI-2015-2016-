...
public class ApplicationDaoJdbcImpl implements ApplicationDao {
    ...
    @Override
    public Application findTripByUserId(Long userId, Long tripId) {
	// TODO Auto-generated method stub
	return jdbcTemplate.queryForObject("APPLICATION_FIND_BY_USER_ID",
		new ApplicationMapper(), userId, tripId);
    }

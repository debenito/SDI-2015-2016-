...
public class UsuarioLogic implements UsuarioLogica {
    ...
    @Override
    public User modificar(User usuario, String email, String login,
	    String nombre, String passNueva, String apellidos) {
    ...
    @Override
    public void registrarUsuario(User usuario, String login, String nombre,
	...
	if (userByLogin.getLogin().equals(nombreUsuario)

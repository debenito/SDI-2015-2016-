...
public class ViajeLogic implements ViajeLogica {
	...
	if(usuario == null)
	return dao.listarViajesActivos(hoy,Long.MIN_VALUE);
	else
	return dao.listarViajesActivos(hoy,usuario.getId());
	...
	return dao.listaViajesParticipacionPromotor(usuario.getId());
    }
	...
	// TODO Auto-generated method stub
	return dao.listaViajesParticipacionPendientes(usuario.getId());
    }
	...
	// TODO Auto-generated method stub
	return dao.listaViajesParticipacionSinPlaza(usuario.getId());
    }
	...
	// TODO Auto-generated method stub
	return dao.listaViajesParticipacionAdmitido(usuario.getId());
    }
	...
	// TODO Auto-generated method stub
	return dao.listaViajesParticipacionExcluido(usuario.getId());
    }
